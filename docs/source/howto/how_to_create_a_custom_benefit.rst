...
Wshop ships with several offer benefits for building offers.  There are three
types:
...
Wshop also lets you create your own benefits for use in offers.  
...
A benefit class must be a proxy class and have the following methods::
    ...
    from wshop.apps.offer import models
    ...
    class MyCustomBenefit(models.Benefit):
        ...
        def apply(self, basket, condition, offer):
            ...
            ``wshop.apps.offer.models.ApplicationResult``
            """
...
``wshop.apps.offer.models.ApplicationResult``.  There are three subtypes
provided:
    
    * ``wshop.apps.offer.models.BasketDiscount``. This takes an amount as it's
      constructor parameter.

    * ``wshop.apps.offer.models.ShippingDiscount``. This indicates that the
      benefit affects the shipping charge.

    * ``wshop.apps.offer.models.PostOrderAction``. This indicates that the
