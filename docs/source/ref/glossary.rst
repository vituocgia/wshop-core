...
This is a work-in-progress list of commonly used terms when discussing Wshop.
...
.. glossary::
    ...
    Fulfillment partner
       ...
       .. seealso:: Related model: :class:`wshop.apps.partner.abstract_models.AbstractPartner`
    ...
    Stock-keeping unit.
       ...
       :attr:`StockRecord <wshop.apps.partner.abstract_models.AbstractStockRecord.partner_sku>`
    ...
    Product Class
        ...
        Product classes are an important concept in Wshop. Each product is
        ...
        :attr:`tracked <wshop.apps.catalogue.abstract_models.AbstractProductClass.track_stock>`
        for the associated products, and whether they
        :attr:`require shipping <wshop.apps.catalogue.abstract_models.AbstractProductClass.requires_shipping>`.
        So if you have products that require shipping and ones which don't,
        you'll need at least two product classes.

        Used for defining
        :class:`options <wshop.apps.catalogue.abstract_models.AbstractOption>`
        and
        :class:`attributes <wshop.apps.catalogue.abstract_models.AbstractProductAttribute>`
    ...
    Product Category
        ...
        logic in Wshop considers a product's category.
