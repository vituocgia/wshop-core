...
Wshop ships with a powerful and flexible offers engine which is contained in the
...
Wshop's dashboard can be used to administer offers.
...
exist in core Wshop but can be implemented using the 'accounts' plugin).
...
.. automodule:: wshop.apps.offer.abstract_models
    :members:

Models
-------

.. automodule:: wshop.apps.offer.models
    :members:

Views
-----

.. automodule:: wshop.apps.offer.views
    :members:
