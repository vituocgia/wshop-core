=======================
Wshop 0.5 release notes
=======================

Welcome to Wshop 0.5!

These release notes cover the `new features`_ as well as `upgrading advice`_.

.. _`new features`: `What's new in Wshop 0.5?`_
...
gone into reworking Wshop's structure to be more extensible.

Thanks to all the contributors who helped with this release.

What's new in Wshop 0.5?
========================
...
Wshop now uses Transifex_ to manage its translation files.  Since 0.4, a
...
.. figure:: screenshots/0.5/transifex.png
    ...
    A snippet from the Wshop Transifex page.

Wshop's default templates also now support a simple language picker.
...
* Wshop's documentation has been reorganised and improved.  This is part of an
  ongoing effort to improve it.  Watch this space.

* Wshop's template now use django-compressor_ to compress CSS and JS assets.
...
Several improvements have been made to ease development of Wshop (and Wshop
projects):

* The sandbox can be configured to compile the LESS files directly.  This is
  useful for developing Wshop's CSS/LESS files.

* A new management command ``wshop_fork_statics`` has been added to help with
  setting up static files for a new Wshop project.
...
* Wshop ships with profiling tools.  There is a decorator and middleware
  available in ``wshop.profiling`` that can be used to help profile Wshop sites.
...
* Some testing utilities have been extracted into a new package,
  wshop-core-testsupport_, so they can be used by Wshop extensions.

* A Vagrant_ manifest is provided for testing Wshop against different database
  vendors.
* Wshop's javascript has been rewritten to be cleaner and more extensible.

* Coverage data is now submitted to coveralls.io_

.. _coveralls.io: https://coveralls.io/r/wshop-core/wshop-core
.. _wshop-core-testsupport: https://github.com/vituocgia/wshop-core-testsupport
...
This section describes changes in core Wshop that you need to be aware of if you
