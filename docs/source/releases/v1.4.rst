=======================
Wshop 1.4 release notes
=======================

:release: 2017-02-10

Welcome to Wshop 1.4, a relative minor release which finally brings
...
Wshop 1.4 is compatible with Django 1.8, 1.9 and 1.10 as well as Python 2.7,
3.3, 3.4, 3.5 and 3.6.


.. _new_in_1.4:

What's new in Wshop 1.4?
------------------------
...
~~~~~~~~~~~~~
 ...
 - Wshop now set's the ``on_delete`` kwarg on all ForeignKey's since leaving
   it out is deprecated in Django 1.10+
 - ``wshop.core.compat.user_is_authenticated()`` is now used instead of 
