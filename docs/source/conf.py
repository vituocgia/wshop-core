# -*- coding: utf-8 -*-
#
# wshop-core documentation build configuration file, created by
...
from wshop import get_version, get_short_version
version = get_version()
...
issues_github_path = 'wshop-core/wshop-core'
...
htmlhelp_basename = 'wshop-coredoc'
...
latex_documents = [
  ('index', 'wshop-core.tex', u'wshop-core Documentation',
   u'DiepDT', 'manual'),
]
...
man_pages = [
    ('index', 'wshop-core', u'wshop-core Documentation',
     [u'DiepDT'], 1)
]
