...
Wshop uses pytest_ to run the tests.
...
When running a subset of tests, Wshop uses the spec_ plugin.  It is a good
...
For example::
    ...
    rootdir: /Users/sasha0/projects/djangowshop, inifile: setup.cfg
