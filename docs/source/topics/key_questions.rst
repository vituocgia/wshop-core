...
The design philosophy of Wshop is to not make a decision for you here, but to
...
application.  Much of Wshop's documentation is in the form of "recipes" that
...
need to capture the attributes of your product types within your models.  Wshop
...
Wshop provides classes for free shipping, fixed charge shipping, pre-order and
...
The checkout app within ``wshop-core`` is suitably flexible that all of these
