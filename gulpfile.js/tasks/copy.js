var gulp = require("gulp"),
    ...
    copyTask = function(cb) {
        gulp.src("node_modules/jquery/dist/jquery.min.js")
            .pipe(gulp.dest("src/wshop/static/wshop/js/jquery"));

        gulp.src("node_modules/bootstrap/less/**/*")
            .pipe(gulp.dest("src/wshop/static/wshop/less/bootstrap3"));

        gulp.src("node_modules/bootstrap/dist/js/bootstrap.min.js")
            .pipe(gulp.dest("src/wshop/static/wshop/js/bootstrap3"));

        gulp.src("node_modules/bootstrap/fonts/*")
            .pipe(gulp.dest("src/wshop/static/wshop/fonts/"));

        gulp.src([
            "node_modules/bootstrap-datetime-picker/js/*.min.js",
            "node_modules/bootstrap-datetime-picker/css/*.min.css"
        ]).pipe(gulp.dest("src/wshop/static/wshop/js/bootstrap-datetimepicker"));

        gulp.src("node_modules/bootstrap-datetime-picker/js/locales/*")
            .pipe(gulp.dest("src/wshop/static/wshop/js/bootstrap-datetimepicker/locales"));
        ...
        gulp.src("node_modules/jquery.inputmask/dist/jquery.inputmask.bundle.js")
            .pipe(gulp.dest("src/wshop/static/wshop/js/inputmask"));

        gulp.src("node_modules/jquery-mousewheel/jquery.mousewheel.js")
            .pipe(gulp.dest("src/wshop/static/wshop/js/mousewheel"));

        gulp.src("node_modules/jquery-sortable/source/js/jquery-sortable-min.js")
            .pipe(gulp.dest("src/wshop/static/wshop/js/jquery-sortable"));
        ...
        ]).pipe(gulp.dest("src/wshop/static/wshop/js/tinymce"));

        gulp.src([
            "node_modules/select2/dist/js/select2.min.js",
            "node_modules/select2/dist/css/select2.min.css"
        ]).pipe(gulp.dest("src/wshop/static/wshop/js/select2"));

        gulp.src("node_modules/select2-bootstrap-theme/dist/*.min.css")
            .pipe(gulp.dest("src/wshop/static/wshop/css"));
    };
