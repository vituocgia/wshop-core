...
from wshop.apps.address.models import Country
from wshop.apps.checkout.forms import ShippingAddressForm
...
class TestShippingAddressForm(TestCase):
    ...
    @override_settings(WSHOP_REQUIRED_ADDRESS_FIELDS=('last_name', 'postcode'))
