...
from wshop.apps.checkout.calculators import OrderTotalCalculator
from wshop.apps.checkout.mixins import CheckoutSessionMixin, OrderPlacementMixin
from wshop.apps.checkout.exceptions import FailedPreCondition
from wshop.core.loading import get_model
from wshop.test import factories
from wshop.test.basket import add_product
from wshop.test.utils import RequestFactory
from wshop.apps.shipping.methods import FixedPrice, Free
