...
from wshop.apps.dashboard.offers import views as offer_views
from wshop.apps.dashboard.ranges import views as range_views
from wshop.core.loading import get_model
from wshop.test.factories import catalogue, offer
