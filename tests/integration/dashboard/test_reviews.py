...
from wshop.apps.dashboard.reviews import views
from wshop.core.loading import get_model
from wshop.test.factories.catalogue import ProductReviewFactory
from wshop.test.factories.customer import UserFactory
