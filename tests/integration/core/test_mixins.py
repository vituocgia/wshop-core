...
from wshop.apps.address.forms import AbstractAddressForm
from wshop.apps.address.models import UserAddress
from wshop.apps.order.models import ShippingAddress
from wshop.forms.mixins import PhoneNumberMixin
from wshop.test.factories import CountryFactory
...
class PhoneNumberMixinTestCase(TestCase):
    ...
    @override_settings(WSHOP_REQUIRED_ADDRESS_FIELDS=('phone_number',))
    ...
    @override_settings(WSHOP_REQUIRED_ADDRESS_FIELDS=[])
