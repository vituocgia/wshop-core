...
from wshop.apps.catalogue.models import Option
from wshop.apps.partner import availability, prices, strategy
...
class TestANonEmptyBasket(TestCase):
    ...
    def test_max_allowed_quantity(self):
        ...
        with self.settings(WSHOP_MAX_BASKET_QUANTITY_THRESHOLD=20):
        ...
        with self.settings(WSHOP_MAX_BASKET_QUANTITY_THRESHOLD=None):
            max_allowed, basket_threshold = self.basket.max_allowed_quantity()
