...
from wshop.apps.partner.importers import CatalogueImporter
from wshop.apps.partner.exceptions import ImportingError
from wshop.apps.catalogue.models import ProductClass, Product
from wshop.apps.partner.models import Partner
