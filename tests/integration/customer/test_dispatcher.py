...
from wshop.apps.customer.utils import Dispatcher, get_password_reset_url
from wshop.apps.customer.models import CommunicationEventType, Email
from wshop.apps.order.models import CommunicationEvent
from wshop.test.factories import create_order, SiteFactory
