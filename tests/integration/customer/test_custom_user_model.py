...
from wshop.apps.customer.forms import ProfileForm
from wshop.core.compat import existing_user_fields, get_user_model
from wshop.test.factories.customer import ProductAlertFactory, UserFactory
