...
from wshop.apps.offer.applicator import Applicator
from wshop.apps.offer.models import Benefit
from wshop.apps.shipping.models import OrderAndItemCharges, WeightBased
