...
from wshop.test.factories import Member

from wshop.apps.dashboard.widgets import RelatedFieldWidgetWrapper


@override_settings(ROOT_URLCONF='wshop.test.factories.urls')
