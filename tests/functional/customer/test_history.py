...
from wshop.apps.customer import history
from wshop.core.compat import get_user_model, unquote_cookie
from wshop.templatetags.history_tags import get_back_button
...
class TestAUserWhoLogsOut(WebTestCase):
    ...
    def test_has_their_cookies_deleted_on_logout(self):
        ...
        self.assertTrue((COOKIE_NAME not in response.test_app.cookies)
                        or not self.app.cookies.get('wshop_recently_viewed_products', None))
