...
from wshop.apps.customer.alerts.utils import (
    send_alert_confirmation, send_product_alerts)
from wshop.apps.customer.forms import ProductAlertForm
...
class TestAUserWithAnActiveStockAlert(WebTest):
    ...
    @mock.patch('wshop.apps.customer.alerts.utils.services.notify_user')
...
class TestAlertMessageSending(TestCase):
    ...
    @mock.patch('wshop.apps.customer.utils.Dispatcher.dispatch_direct_messages')
    ...
    @mock.patch('wshop.apps.customer.utils.Dispatcher.dispatch_user_messages')
    ...
    @mock.patch('wshop.apps.customer.alerts.utils.loader.get_template')
    def test_deprecated_notification_templates_work(self, mock_loader):
        ...
        with warnings.catch_warnings(record=True) as warning_list:
            ...
            self.assertTrue(
                any(item.category == RemovedInWshop20Warning for item in warning_list))
