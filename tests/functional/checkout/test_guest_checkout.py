...
@override_settings(WSHOP_ALLOW_ANON_CHECKOUT=True)
...
class TestShippingMethodView(CheckoutMixin, WebTestCase):
    ...
    @mock.patch('wshop.apps.checkout.views.Repository')
...
class TestPaymentDetailsView(CheckoutMixin, WebTestCase):
    ...
    @mock.patch('wshop.apps.checkout.views.PaymentDetailsView.handle_payment')
    ...
    @mock.patch('wshop.apps.checkout.views.logger')
    @mock.patch('wshop.apps.checkout.views.PaymentDetailsView.handle_payment')
    ...
    @mock.patch('wshop.apps.checkout.views.logger')
    @mock.patch('wshop.apps.checkout.views.PaymentDetailsView.handle_order_placement')
