...
from wshop.views import handler403, handler404, handler500
...
urlpatterns = [
    ...
    # i18n URLS need to live outside of i18n_patterns scope of Wshop
...
# Prefix Wshop URLs with language codes
