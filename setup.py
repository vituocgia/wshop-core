...
- Ensure the version is correctly set in wshop.__init__.py
- Run: make release
"""
import os
import re
...
from wshop import get_version  # noqa isort:skip
...
install_requires = [
    ...
    # Used for wshop.test.contextmanagers.mock_signal_receiver
    'mock>=1.0.1,<3.0',
    # Used for wshop.test.newfactories
...
setup(
    ...
    url='https://github.com/vituocgia/wshop-core',
    author="DiepDT",
...
if len(sys.argv) > 1 and sys.argv[1] == 'develop':
    docs_url = 'https://wshop-core.readthedocs.io/en/latest/internals/contributing/index.html'
    mailing_list = 'wshop-core@googlegroups.com'
    mailing_list_url = 'https://groups.google.com/forum/?fromgroups#!forum/wshop-core'
    twitter_url = 'https://twitter.com/django_wshop'
    msg = (
        "You're installing Wshop in 'develop' mode so I presume you're thinking\n"
        "of contributing:\n\n"
        ...
        "have a look at:\n    %s\n"
        "(d) Consider following @django_wshop on Twitter to stay up-to-date\n"
