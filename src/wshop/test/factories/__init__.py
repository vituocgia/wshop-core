...
from wshop.test.factories.address import *  # noqa
from wshop.test.factories.basket import *  # noqa
from wshop.test.factories.catalogue import *  # noqa
from wshop.test.factories.contrib import *  # noqa
from wshop.test.factories.customer import *  # noqa
from wshop.test.factories.models import *  # noqa
from wshop.test.factories.offer import *  # noqa
from wshop.test.factories.order import *  # noqa
from wshop.test.factories.partner import *  # noqa
from wshop.test.factories.payment import *  # noqa
from wshop.test.factories.voucher import *  # noqa
from wshop.test.factories.wishlists import *  # noqa
...
def create_stockrecord(product=None, price_excl_tax=None, partner_sku=None,
                       ...
                       currency=settings.WSHOP_DEFAULT_CURRENCY,
                       partner_users=None):
    if product is None:
