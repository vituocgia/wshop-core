...
class ImageInput(FileInput):
    ...
    """
    template_name = 'wshop/forms/widgets/image_input_widget.html'
...
class DateTimeWidgetMixin(object):
    ...
    template_name = 'wshop/forms/widgets/date_time_picker.html'
