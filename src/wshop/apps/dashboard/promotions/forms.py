...
from wshop.apps.promotions.conf import PROMOTION_CLASSES
from wshop.core.loading import get_class, get_classes
from wshop.forms.fields import ExtendedURLField
...
class PagePromotionForm(forms.ModelForm):
    ...
    position = forms.CharField(
        widget=forms.Select(choices=settings.WSHOP_PROMOTION_POSITIONS),
        label=_("Position"),
