...
from wshop.apps.order import exceptions as order_exceptions
from wshop.apps.payment.exceptions import PaymentError
from wshop.core.compat import UnicodeCSVWriter
from wshop.core.loading import get_class, get_model
from wshop.core.utils import datetime_combine, format_datetime
from wshop.views import sort_queryset
...
class OrderListView(BulkEditMixin, ListView):
    ...
    def get_queryset(self):  # noqa (too complex (19))
        ...
        if data['name']:
            ...
            allow_anon = getattr(settings, 'WSHOP_ALLOW_ANON_CHECKOUT', False)
