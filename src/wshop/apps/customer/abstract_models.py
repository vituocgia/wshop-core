...
class AbstractUser(auth_models.AbstractBaseUser,
    ...
    """
    An abstract base user suitable for use in Wshop projects.
    ...
    def save(self, *args, **kwargs):
        ...
        # see Wshop ticket #1127, Django ticket #19218
...
class AbstractCommunicationEventType(models.Model):
    ...
    # it's a useful convention that's been enforced in previous Wshop versions
    code = AutoSlugField(
    ...
    # instructs Wshop to look for a file-based template, '' is just an empty
    # template.
    ...
    def get_messages(self, ctx=None):
        ...
        ctx['static_base_url'] = getattr(
            settings, 'WSHOP_STATIC_BASE_URL', None)
