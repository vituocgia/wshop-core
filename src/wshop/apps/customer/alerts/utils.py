...
from wshop.apps.customer.notifications import services
...
logger = logging.getLogger('wshop.alerts')
...
def send_alert_confirmation(alert):
    ...
    # This will be removed in Wshop 2.0
    try:
        ...
        warnings.warn(
            ...
            category=RemovedInWshop20Warning, stacklevel=2
        )
