...
from wshop.apps.customer.signals import user_registered
...
logger = logging.getLogger('wshop.customer')
...
class RegisterUserMixin(object):
    ...
    def register_user(self, form):
        ...
        if getattr(settings, 'WSHOP_SEND_REGISTRATION_EMAIL', True):
        ...
        try:
            ...
            # twice, this is about the only place in Wshop where we don't
