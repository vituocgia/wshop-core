...
from wshop.apps.customer.utils import get_password_reset_url, normalise_email
from wshop.core.compat import (
    existing_user_fields, get_user_model)
from wshop.core.decorators import deprecated
from wshop.core.loading import get_class, get_model, get_profile_class
from wshop.forms import widgets
