...
class AbstractCategory(MP_Node):
    ...
    def full_name(self):
        ...
        It's rarely used in Wshop's codebase, but used to be stored as a
    ...
    def full_slug(self):
        ...
        Wshop used to store this as in the 'slug' model field, but this field
    ...
    def save(self, *args, **kwargs):
        """
        Wshop traditionally auto-generated slugs from names. As that is
...
class AbstractProduct(models.Model):
    ...
    def is_review_permitted(self, user):
        ...
        Default implementation respects WSHOP_ALLOW_ANON_REVIEWS and only
        ...
        """
        if user.is_authenticated or settings.WSHOP_ALLOW_ANON_REVIEWS:
...
class AbstractProductAttributeValue(models.Model):
    ...
    value_file = models.FileField(
        upload_to=settings.WSHOP_IMAGE_FOLDER, max_length=255,
...
class MissingProductImage(object):
    ...
    into MEDIA_ROOT for convenience, as that is necessary every time an Wshop
    ...
    def __init__(self, name=None):
        self.name = name if name else settings.WSHOP_MISSING_IMAGE_URL
    ...
    def symlink_missing_image(self, media_file_path):
        static_file_path = find('wshop/img/%s' % self.name)
        if static_file_path is not None:
            try:
                ...
                raise ImproperlyConfigured((
                    ...
                    "This exception was raised because Wshop was unable to "
...
class AbstractProductImage(models.Model):
    ...
    original = models.ImageField(
        _("Original"), upload_to=settings.WSHOP_IMAGE_FOLDER, max_length=255)
