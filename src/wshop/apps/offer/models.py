...
from wshop.apps.offer.benefits import *  # noqa isort:skip
from wshop.apps.offer.conditions import *  # noqa isort:skip

from wshop.apps.offer.benefits import __all__ as benefit_classes  # noqa isort:skip
from wshop.apps.offer.conditions import __all__ as condition_classes  # noqa isort:skip
