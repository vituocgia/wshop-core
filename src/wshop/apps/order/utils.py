...
class OrderCreator(object):
    ...
    def place_order(self, basket, total,  # noqa (too complex (12))
        ...
        if not status and hasattr(settings, 'WSHOP_INITIAL_ORDER_STATUS'):
            status = getattr(settings, 'WSHOP_INITIAL_ORDER_STATUS')
