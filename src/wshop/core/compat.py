...
def get_user_model():
    ...
    Support for Django 1.4 has since been dropped in Wshop, but our
    ...
    try:
        ...
        # backwards compatibility with previous Wshop versions and the
    ...
    * Writing to a new file:
    ...
    def add_bom(self, f):
        ...
        if (self.encoding == 'utf-8'
                and getattr(settings, 'WSHOP_CSV_INCLUDE_BOM', False)):
