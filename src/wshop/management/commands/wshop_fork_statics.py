...
class Command(BaseCommand):
    """
    Copy Wshop's statics into local project so they can be used as a base for
    styling a new site.
    """
    help = "Copy Wshop's static files"
    ...
    def handle(self, *args, **options):
        ...
        print("Copying Wshop's static files to %s" % (destination,))
