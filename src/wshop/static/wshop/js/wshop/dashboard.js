    ...
    o.dashboard = {
        ...
        initDatePickers: function(el) {
            if ($.fn.datetimepicker) {
                ...
                var $dates = $(el).find('[data-wshopWidget="date"]').not('.no-widget-init').not('.no-widget-init *');
                ...
                var $datetimes = $(el).find('[data-wshopWidget="datetime"]').not('.no-widget-init').not('.no-widget-init *');
                ...
                var $times = $(el).find('[data-wshopWidget="time"]').not('.no-widget-init').not('.no-widget-init *');
        ...
        offers: {
            init: function() {
                wshop.dashboard.offers.adjustBenefitForm();
